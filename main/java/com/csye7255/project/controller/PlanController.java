...
public class PlanController {
    ...
    public ResponseEntity<String> getInsurancePlan(@PathVariable(value = "id") String planId, HttpServletRequest request, @RequestHeader HttpHeaders header) {
        try {
    ...
    public String validateJson1(JSONObject jsonData) throws Exception{
        BufferedReader bufferedReader = new BufferedReader(new FileReader("C:/Users/abark/Downloads/project (1)/project/project/project/src/main/resources/static/Service.json"));
